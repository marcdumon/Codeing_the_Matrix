...
# import os, sys, doctest, traceback, urllib.request, urllib.parse, urllib.error, base64, ast, re, importlib, ast
...
def check_signature(response):
    key = PublicKey(
        N=,
...
def get_asgn_data(asgn_name):
    print('http://%s/%s.tests' % (static_url, asgn_name))
    try:
